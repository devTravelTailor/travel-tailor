...
function BlogsList() {
  ...
  return (
    <div className={styles.blogsPage}>
      <section className='flex w-full flex-col md:flex-row gap-6 max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12 h-screen overflow-hidden'>
        <nav
          ...
          md:h-[calc(100vh-var(--header-height,0px)-2rem)] lg:h-full md:overflow-y-auto scrollbar-hidden py-4 md:py-6 md:pr-4`}>
