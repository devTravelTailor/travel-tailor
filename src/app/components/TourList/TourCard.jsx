...
export function TourCard({
  ...
  return (
    <Link
      ...
      className="block"
    >
      <Card className="group h-full min-h-[520px] p-0 flex flex-col overflow-hidden bg-card border-border/50 hover:shadow-xl transition-all duration-500 cursor-pointer">
