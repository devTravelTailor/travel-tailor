    ...
    <section className='relative min-h-screen overflow-hidden'>
      ...
      {stats && (
        <div className=' bg-[#ff7e3d]'>
          <div className='max-w-7xl mx-auto px-4 sm:px-10 lg:px-24 py-4'>
            <div className='flex flex-wrap md:flex-nowrap items-center justify-center md:justify-between gap-3 md:gap-4 whitespace-normal md:whitespace-nowrap text-xs md:text-base w-full'>
              {stats?.happyTravelers !== null && (
                <>
                  <div className='flex min-w-[6.5rem] items-center gap-2 group justify-center md:justify-start text-center md:text-left'>
                    <div className='hidden md:flex w-10 h-10 rounded-full bg-white/20 items-center justify-center group-hover:bg-white/30 transition-colors'>
              ...
              {stats?.rating !== null && (
                <div className='flex min-w-[6.5rem] max-md:hidden items-center gap-2 group justify-center md:justify-start text-center md:text-left'>
                  <div className='hidden md:flex w-10 h-10 rounded-full bg-white/20 items-center justify-center group-hover:bg-white/30 transition-colors'>
          ...
          <div className='container mx-auto px-7'>
            ...
            {creators.length > 0 && (
              <div className='md:p-5 w-full max-md:text-center'>
                <h3 className='text-2xl font-bold mb-6 px-3 transition-colors duration-200 hover:text-[#ff5b06] cursor-pointer'>
                  Our Smiths
                </h3>
